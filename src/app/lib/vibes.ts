export const VIBES = {
  ...
  plum: ["#DDA0DD", "#BA55D3", "#9370DB", "#8B7AB8"],
  olive: ["#9ACD32", "#8FBC8F", "#6B8E23", "#808000"],
  slate: ["#708090", "#778899", "#696969", "#2F4F4F"],
  amber: ["#FFBF00", "#FFD700", "#FFA500", "#FF8C00"],
  ...
  sage: ["#9CAF88", "#B8C5A6", "#A8B5A0", "#C9D1C8"],
  lavender: ["#E6E6FA", "#D8BFD8", "#DDA0DD", "#C8A2C8"],
  peach: ["#FFDBAC", "#FFE5B4", "#FFDAB9", "#F5DEB3"],
  mint: ["#B8E6B8", "#C7F0C7", "#D4F1D4", "#E0F2E0"],
  rose: ["#F4C2C2", "#F8D7DA", "#FADBD8", "#F2D7D5"],
  sky: ["#E0F6FF", "#B8E0FF", "#D6EAF8", "#EBF5FB"],
  sand: ["#F4E4BC", "#F7E7CE", "#F5E6D3", "#E8DAEF"],
  mist: ["#F8F9FA", "#E9ECEF", "#DEE2E6", "#CED4DA"],
};
